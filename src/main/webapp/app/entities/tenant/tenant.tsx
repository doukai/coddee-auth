  ...
  return (
    <div>
      <h2 id="tenant-heading">
        <Translate contentKey="coddeeApp.tenant.home.title">Tenants</Translate>
      </h2>
        ...
        {tenantList && tenantList.length > 0 ? (
            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={sort('domain')}>
                  <Translate contentKey="coddeeApp.tenant.domain">Domain</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={sort('tenantName')}>
                  <Translate contentKey="coddeeApp.tenant.tenantName">Tenant Name</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="coddeeApp.tenant.home.notFound">No Tenants found</Translate>
            </div>
          )
        )}
      </div>
