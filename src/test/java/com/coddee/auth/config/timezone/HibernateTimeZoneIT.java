package com.coddee.auth.config.timezone;

import static java.lang.String.format;
import static org.assertj.core.api.Assertions.assertThat;

import com.coddee.auth.CoddeeApp;
import com.coddee.auth.repository.timezone.DateTimeWrapper;
import com.coddee.auth.repository.timezone.DateTimeWrapperRepository;
import java.time.*;
...
public class HibernateTimeZoneIT {
    ...
    private String generateSqlRequest(String fieldName, long id) {
        return format("SELECT %s FROM auth_date_time_wrapper where id=%d", fieldName, id);
    }
